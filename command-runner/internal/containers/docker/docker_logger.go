...
func logDockerResponse(logger *zerolog.Logger, dockerResponse io.ReadCloser, isError bool) error {
...
func writeLog(logger *zerolog.Logger, isError bool, format string, args ...interface{}) {
	if isError {
